...
params AS (
  SELECT
    TIMESTAMPTZ '2025-08-21 15:00:00+00' AS win_start,    -- :win_start
    TIMESTAMPTZ '2025-08-22 07:00:00+00' AS win_end,      -- :win_end
