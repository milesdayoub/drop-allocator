...
WITH eligible_users AS (
  ...
  WHERE  uce.is_eligible = TRUE
    ...
    AND  c.start_datetime <= '2025-08-14 15:00:00+00'
    AND  c.end_datetime   >= '2025-08-15 07:00:00+00'
),
group_from_agg AS (
